...
class AudioManager
{
	...
	**/
	...
	#else
	public static var onDefaultPlaybackDeviceChanged:Dynamic = null;
	#end
	...
	**/
	...
	#else
	public static var onPlaybackDeviceAdded:Dynamic = null;
	#end
	...
	**/
	...
	#else
	public static var onPlaybackDeviceRemoved:Dynamic = null;
	#end
	...
	**/
	...
	#else
	public static var onDefaultCaptureDeviceChanged:Dynamic = null;
	#end
	...
	**/
	...
	#else
	public static var onCaptureDeviceAdded:Dynamic = null;
	#end
	...
	**/
	...
	#else
	public static var onCaptureDeviceRemoved:Dynamic = null;
	#end
	...
	**/
	...
	{
		#if (lime_openal && lime_openalsoft && !lime_doc_gen)
	...
	**/
	...
	{
		#if hl var message:String = _message != null ? @:privateAccess String.fromUTF8(_message) : null; #end
